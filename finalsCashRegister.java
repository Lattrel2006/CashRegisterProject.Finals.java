...
public class Main {
    ...
    public static void signUp() {
        ...
        while (true) {
            try {
                ...
                boolean userExists = users.stream().anyMatch(user -> user.username.equals(username));
                if (userExists) {
    ...
    public static void addProduct() {
        try {
            ...
            if (name.isEmpty()) {
                System.out.println("Error: Coffee flavor cannot be empty.\n");
                return;
            }
            ...
            System.out.println("\n " + selectedSize + " " + name + " Coffee added to cart!\n");

        } catch (Exception e) {
            System.out.println("Error: Failed to add Coffee. Please try again.\n");
        }
    }
    ...
    public static void updateProductQuantity() {
        ...
        try {
            displayCart();
            int index = getValidChoice("Enter Coffee number to update (1-" + cart.size() + "): ", 1, cart.size()) - 1;
            ...
            System.out.println("Error: Failed to update Coffee quantity.\n");
        }
    }
    ...
    public static void removeProduct() {
        ...
        try {
            displayCart();
            int index = getValidChoice("Enter Coffee number to remove (1-" + cart.size() + "): ", 1, cart.size()) - 1;

            Product removedProduct = cart.remove(index);
            System.out.println("\n " + removedProduct.name + " (" + removedProduct.size + ") removed from cart!\n");

        } catch (Exception e) {
            System.out.println("Error: Failed to remove Coffee.\n");
        }
    }
    ...
    public static void main(String[] args) {
        System.out.println("\n=======================================");
        System.out.println("    Welcome to Lattrel Coffee Shop!");
        ...
        while (true) {
            try {
                ...
                switch (choice) {
                    ...
                    case 3:
                        System.out.println("\n================================================");
                        System.out.println(" Thank you for visiting Lattrel Coffee Shop!");
    ...
    public static void runCashRegister() {
        while (true) {
            try {
                ...
                System.out.println("1. Add Coffee to Cart");
                System.out.println("2. View Cart");
                System.out.println("3. Update Coffee Quantity");
                System.out.println("4. Remove Coffee from Cart");
